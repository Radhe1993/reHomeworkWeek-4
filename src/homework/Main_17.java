...
public class Main_17 {
        ...
        {
            Carpet_17 carpet = new Carpet_17(3.5);
            Floor_17 floor = new Floor_17(2.75, 4.0);
            Calculator_17 calculator = new Calculator_17(floor, carpet);
            System.out.println("total= " + calculator.getTotalCost());
            carpet = new Carpet_17(1.5);
            floor = new Floor_17(5.4, 4.5);
            calculator = new Calculator_17(floor, carpet);
            System.out.println("total= " + calculator.getTotalCost());
        }
    }
